...
parser.add_argument('--conf', default='/root/workspace/MDD/CTC-Attention-Mispronunciation/egs/wavlm/conf/ctc_config.yaml', help='conf file for training')
#w = open("ctc_outseq",'w+')
...
def test():
    ...
    test_dataset = SpeechDataset(vocab, opts.test_scp_path, opts.test_lab_path,opts.test_trans_path, opts.test_wav_path, opts, False)
    ...
    with torch.no_grad():
        for data in test_loader:
            inputs, input_sizes, targets, target_sizes = data #
