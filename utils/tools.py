...
def load_audio(path):
    ...
    resample = torchaudio.transforms.Resample(orig_freq=_, new_freq=target_sample_rate)
...
def process_label_file(class2int, label_file, label_type):
    '''
    Input:
